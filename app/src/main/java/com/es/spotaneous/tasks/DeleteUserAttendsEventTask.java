 ...
 */
public class DeleteUserAttendsEventTask extends AsyncTask<String, Void, Void> {

    protected StatusLine statusLine;
    private Context mContext;

    public DeleteUserAttendsEventTask(Context context) {
        mContext = context;
    }
    ...
    protected Void doInBackground(String... strings) {
        ...
        String urlString = Server.SERVER_ADDRESS + "/" + Server.SERVER_USER_EVENT_DELETE + "/?user_id=" + idUser + "&event_id=" + idEvent;
